...
//    UIButton *btnn=[[UIButton alloc]init];
//    btnn.backgroundColor=[UIColor yellowColor];
//    [tf1 addSubview:btnn];
//    [btnn addTarget:self action:@selector(btnnClick:) forControlEvents:UIControlEventTouchDragInside];
//    [btnn mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(tf1.mas_top);
//        make.right.equalTo(tf1.mas_right);
//        make.bottom.equalTo(tf1.mas_bottom);
