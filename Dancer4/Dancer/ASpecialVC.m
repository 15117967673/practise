...
@interface ASpecialVC ()<PSCollectionViewDelegate, PSCollectionViewDataSource>
...
- (void)viewDidLoad {
    ...
    _collectionView = [[PSCollectionView alloc] initWithFrame:CGRectMake(0, 0, WIDTH, HEIGHT)];
    ...
    _strUrl=@"http://client-api.dingdone.com/97AX8NW8A6/12288/listcontents?&column_id=133430&from=%d&size=10&site_id=1093";
