...
@interface BSpecialVC ()<PSCollectionViewDelegate, PSCollectionViewDataSource>
...
- (void)viewDidLoad {
    ...
    _strUrl=@"http://client-api.dingdone.com/97AX8NW8A6/12288/listcontents?&column_id=133393&from=%d&size=15&site_id=1093";
