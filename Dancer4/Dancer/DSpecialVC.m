...
@interface DSpecialVC ()<PSCollectionViewDelegate, PSCollectionViewDataSource>
...
- (void)viewDidLoad {
    ...
    _strUrl=@"http://client-api.dingdone.com/97AX8NW8A6/12288/listcontents?&column_id=284097&from=%d&size=10&site_id=1093";
